...
var extendConfig = function extendConfig(config) {
  ...
  var transforms = [].concat(_toConsumableArray(incomingTransforms), [(0, _reduxPersistTransformImmutable2.default)()]);
...
exports.getStoredState = _reduxPersist.getStoredState;
